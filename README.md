This project is a responsive and stylish AI chatbot interface built using HTML, CSS, and JavaScript, integrated with Google's Gemini 1.5 Flash model via the Generative Language API.
